...
<body>
    ...
    <form class="form_container" action="login.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="input_container" data-validate = "Product name is required">
        ...
        <div class="input_container">
          ...
          <input placeholder="Password" title="Inpit title" name="lgn_pass" type="password" class="input_field" id="password_field" required="True">
        </div>
        ...
        <div class="separator">   
          <hr class="line">
          <span><a href="user login.php">User</a></span>
          <hr class="line">
        </div>
      </form>    
</body>
