            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="models/index.php" method="POST" class="register-form" id="register-form">
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="reg_name" id="name" placeholder="Your Name"/ required="True">
                            </div>
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="text" name="reg_phone" id="email" placeholder="Your Phone"/ required="True">
                            </div>
                            <div class="form-group">
                                <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="reg_pass" id="pass" placeholder="Password"/ required="True">
                            </div>
                        ...
                        <a href="user login.php" class="signup-image-link">LOGIN</a>
                    </div>
                </div>
            </div>
        </section>
