...
<body>
  ...
  ?>
    ...
    <form class="form_container_register" action="index2.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="input_container">
          <label class="input_label" for="email_field">Username [id]</label>
          ...
          <input placeholder="name910" title="Inpit title" name="reg_name" type="text" class="input_field" id="email_field" >
          <span><?php #print $user_error; ?></span>
        </div>

        <div class="input_container">
          <label class="input_label" for="password_field">Phone</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
          ...
          <input placeholder="Phone" title="Inpit title" name="reg_phone" type="text" class="input_field" id="phone" max="5">
          <span><?php #print $phone_error; ?></span>
        </div>
        ...
        <div class="input_container">
            ...
            <input placeholder="Password" title="Inpit title" name="reg_pass" type="password" class="input_field" id="password_field" >
            <span><?php #print $pases; ?></span>
          </div>

          <div class="input_container">
            <label class="input_label" for="password_field">Choose Department</label>
        ...
        <button title="Login" type="submit" name="reg_btn" class="sign-in_btn">
          <span>Sign In</span>
        </button>
        ...
        <button title="Sign In" type="submit" class="sign-in_ggl">
          ...
          <span><a href="adminlog.php">Login</a></span>
        </button>
      </form>
</body>
</html>