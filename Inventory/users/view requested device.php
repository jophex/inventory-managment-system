    ...
    <div class="table">
        ...
        <table>
          ...
          function display_devices()
          {
              ...
              $id = 1;
              $sql = "SELECT username, device_name, quantity, device_type, category, user_status, returns FROM requests WHERE user_id ='".$_SESSION['user_log']."'";
            ...
            //   WHERE category = '$category' GROUP BY device_type
              ...
              if ($records !== false && $records->num_rows > 0) {
                  while ($row = mysqli_fetch_array($records)) {
                    ...
                    print"  <td class='status'><span class='active'>" .$row['returns']. "</span></td>";

                  }
              } else {
                  print '<div class="row justify-content-center">
                            <div class="col-md-6 text-center mb-5">
                                <h2 class="heading-section">NO DEVICE FOUND</h2>
                             </div>
                        </div>';
              }
          }
